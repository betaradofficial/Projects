...
def main():
    ...
    opening_text = [
        (
            "You wake up from a terrible dream where you're working 25 hour shifts at Arby's to afford food for yourself.",
            1.5,
        ),
        ('\n"Wait', 1.2),
        (".", 1.2),
    ...
    bed_text = [
        ...
        (
            "\nDuring your peaceful rest you think you hear someone talking to your parents.",
            1.5,
        ),
        ("\nSomething about", 1),
        (".", 1),
